...
-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('PENDING', 'PAYMENT_CONFIRMED', 'SENT_TO_RITE_FOODS', 'PROCESSING_BY_RFL', 'LOADED', 'IN_TRANSIT', 'DELIVERED', 'PARTIALLY_DELIVERED', 'CANCELLED', 'RETURNED');

-- CreateEnum
CREATE TYPE "public"."PaymentStatus" AS ENUM ('PENDING', 'PARTIAL', 'CONFIRMED', 'OVERPAID');

-- CreateEnum
CREATE TYPE "public"."PaymentMethod" AS ENUM ('CASH', 'BANK_TRANSFER', 'CHECK', 'CARD', 'POS', 'WHATSAPP_TRANSFER', 'MOBILE_MONEY');

-- CreateEnum
CREATE TYPE "public"."PaymentType" AS ENUM ('TO_COMPANY', 'TO_RITE_FOODS');

-- CreateEnum
CREATE TYPE "public"."RiteFoodsStatus" AS ENUM ('NOT_SENT', 'PAYMENT_SENT', 'ORDER_RAISED', 'PROCESSING', 'LOADED', 'DISPATCHED');

-- CreateEnum
CREATE TYPE "public"."DeliveryStatus" AS ENUM ('PENDING', 'IN_TRANSIT', 'FULLY_DELIVERED', 'PARTIALLY_DELIVERED', 'FAILED', 'RETURNED');
...
CREATE TABLE "public"."products" (
    ...
    "module" "public"."ProductModule" NOT NULL DEFAULT 'DISTRIBUTION',
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."distribution_orders" (
    ...
    "payment_notes" TEXT,
    "paid_to_rite_foods" BOOLEAN NOT NULL DEFAULT false,
    "amount_paid_to_rite_foods" DECIMAL(12,2),
    "payment_date_to_rite_foods" TIMESTAMP(3),
    "rite_foods_order_number" TEXT,
    "rite_foods_invoice_number" TEXT,
    "rite_foods_status" "public"."RiteFoodsStatus" NOT NULL DEFAULT 'NOT_SENT',
    "order_raised_by_rfl" BOOLEAN NOT NULL DEFAULT false,
    "order_raised_at" TIMESTAMP(3),
    "rite_foods_loaded_date" TIMESTAMP(3),
    "delivery_status" "public"."DeliveryStatus" NOT NULL DEFAULT 'PENDING',
    "delivered_pallets" INTEGER DEFAULT 0,
    "delivered_packs" INTEGER DEFAULT 0,
    "delivered_at" TIMESTAMP(3),
    "delivered_by" TEXT,
    "delivery_notes" TEXT,
    "non_delivery_reason" TEXT,
    "partial_delivery_reason" TEXT,
    "delivery_reviewed_by" TEXT,
    "delivery_reviewed_at" TIMESTAMP(3),
...
CREATE TABLE "public"."haulage_rates" (
    ...
    "rate_15_ton" DECIMAL(10,2) NOT NULL,
    "rate_20_ton" DECIMAL(10,2) NOT NULL,
    "rate_30_ton" DECIMAL(10,2) NOT NULL,
    "effective_date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "haulage_rates_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."salary_rates" (
    ...
    "trip_allowance" DECIMAL(8,2) NOT NULL,
    "driver_wages" DECIMAL(8,2) NOT NULL,
    "motor_boy_wages" DECIMAL(8,2) NOT NULL,
...
CREATE TABLE "public"."price_adjustments" (
    ...
    "adjustment_type" TEXT NOT NULL DEFAULT 'RITE_FOODS_PRICE_CHANGE',
    "reason" TEXT NOT NULL,
    "rite_foods_invoice_ref" TEXT,
...
CREATE TABLE "public"."truck_capacity" (
    ...
    "capacity_type" TEXT NOT NULL DEFAULT '15TON',
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "make" TEXT,
    "model" TEXT,
    "year" INTEGER,
...
CREATE TABLE "public"."transport_orders" (
    ...
    "base_haulage_rate" DECIMAL(10,2),
    "service_charge_percent" DECIMAL(5,2) NOT NULL DEFAULT 10.00,
    "trip_allowance" DECIMAL(8,2) NOT NULL DEFAULT 0,
    "motor_boy_wages" DECIMAL(8,2) NOT NULL DEFAULT 0,
...
CREATE TABLE "public"."distribution_analytics" (
    ...
    CONSTRAINT "distribution_analytics_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."transport_analytics" (
    "id" TEXT NOT NULL,
    "analysis_type" TEXT NOT NULL,
    "period" TEXT,
    "total_revenue" DECIMAL(15,2) NOT NULL,
    "fuel_costs" DECIMAL(15,2) NOT NULL,
    "driver_wages" DECIMAL(15,2) NOT NULL,
    ...
    "average_revenue" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "total_fuel_liters" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "transport_analytics_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "haulage_rates_location_id_effective_date_key" ON "public"."haulage_rates"("location_id", "effective_date");

-- CreateIndex
CREATE UNIQUE INDEX "salary_rates_location_id_effective_date_key" ON "public"."salary_rates"("location_id", "effective_date");
...
-- AddForeignKey
ALTER TABLE "public"."distribution_orders" ADD CONSTRAINT "distribution_orders_payment_confirmed_by_fkey" FOREIGN KEY ("payment_confirmed_by") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."distribution_orders" ADD CONSTRAINT "distribution_orders_delivery_reviewed_by_fkey" FOREIGN KEY ("delivery_reviewed_by") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."payment_history" ADD CONSTRAINT "payment_history_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."distribution_orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."haulage_rates" ADD CONSTRAINT "haulage_rates_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."salary_rates" ADD CONSTRAINT "salary_rates_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."price_adjustments" ADD CONSTRAINT "price_adjustments_adjusted_by_fkey" FOREIGN KEY ("adjusted_by") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
