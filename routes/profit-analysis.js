...
const { authorizeModule, authorizeFeature } = require('../middleware/auth');
...
router.get('/dashboard',
  authorizeFeature('distribution', 'view_profitability'),
  asyncHandler(async (req, res) => {
...
router.post('/recalculate',
  authorizeFeature('distribution', 'manage_profitability'),
  asyncHandler(async (req, res) => {
